...
// ✅ Use public assets as URLs (no ../../public)
const audioFiles = [
  "/assets/Audios/jingle1.mp3",
  "/assets/Audios/jingle2.mp3",
  "/assets/Audios/jingle3.mp3",
  "/assets/Audios/jingle4.mp3",
  "/assets/Audios/jingle5.mp3",
  "/assets/Audios/jingle6.mp3",
];
    ...
    <div className="avg-wrapper">
      <div className="avg-container">
        ...
        <div className="avg-mainheader">
          ...
          <div className="avg-title-underline"></div>
          <div className="avg-accordion">
            <div className="avg-accordion-header">
              + Office Inauguration Photos
            </div>
            <div className="avg-accordion-header">
